...
SFML OOP PROJECT
Contains: 
1. The main GUI Simulation game
2. The project report
3. The class diagram
4. The initial console simulation game



Dependencies
The main "Story" class has dependencies on the following classes:
...
DoorGame
Class Members
The .exe file depends on OpenAL32.dll to run audio.
